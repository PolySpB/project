...
public class UserController {
    ...
    public ResponseEntity getById(@NotNull @PathVariable Integer id) {
        try {
            ...
            return ResponseEntity.ok().body(ErrorUtils.generate(HttpStatus.NOT_FOUND, e.getMessage()));
        }
    }
    ...
    public ResponseEntity update(@Valid @RequestBody UserDto userDto) {
        ...
        try {
            ...
            return ResponseEntity.ok().body(ErrorUtils.generate(HttpStatus.BAD_REQUEST, e.getMessage()));
        }
    }
