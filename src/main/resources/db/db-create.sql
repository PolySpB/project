...
create sequence bank.bankbook_id_seq;
create table bank.bankbook (
    id integer unique not null default nextval('bank.bankbook_id_seq'),
...
create table user.user (
    id integer unique not null default nextval('user.user_id_seq'),
